  ...
  return (
    <section className="section-footer">
      ...
      <div className="footer__row">
        <div className="footer__contact">
          ...
          <p className="footer__contact-email">
            E:{" "}
            <a className="footer__contact-email-text" href="mailto: boonyarit.rd@hotmaill.com">
              boonyarit.rd@hotmail.com
            </a>
          </p>
          <p className="footer__contact-phone">
            P: <span className="footer__contact-phone-text">095 - 809 - 8135</span>
          </p>
        </div>
      ...
      <div className="footer__copyright">
          <img className="footer__copyright-logo" src="./images/logo-outline--grey.svg" alt="logo-footer" />
